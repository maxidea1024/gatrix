...
class LinkPreviewService {
   ...
   * Delegates to formatRelativeTime from dateFormat.ts for localization support
   */
  formatPublishedTime(publishedTime: string): string {
    const result = formatRelativeTime(publishedTime);
    return result === '-' ? publishedTime : result;
  }
}

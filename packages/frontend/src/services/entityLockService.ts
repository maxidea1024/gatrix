...
class EntityLockService {
     ...
     */
    async acquireLock(table: string, entityId: string | number, environment: string): Promise<AcquireLockResult> {
        try {
     ...
     */
    async forceAcquireLock(table: string, entityId: string | number, environment: string): Promise<boolean> {
        try {
     ...
     * Release a soft lock
     */
    async releaseLock(table: string, entityId: string | number, environment: string): Promise<boolean> {
        try {
     ...
     */
    async extendLock(table: string, entityId: string | number, environment: string): Promise<boolean> {
        try {
     ...
     */
    async checkLock(table: string, entityId: string | number, environment: string): Promise<LockCheckResult> {
        try {

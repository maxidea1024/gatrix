 ...
 */
export async function getPlan(flagId: string, environment: string): Promise<ReleaseFlowPlan | null> {
 ...
 */
export async function updateTemplate(id: string, data: Partial<CreateTemplateInput>): Promise<ReleaseFlowTemplate> {
...
export async function setTransitionCondition(
    ...
    const response = await api.put(
        `/admin/release-flows/milestones/${milestoneId}/transition`,
        { intervalMinutes }
    );
    return response.data;
}
 ...
 */
export async function removeTransitionCondition(milestoneId: string): Promise<ReleaseFlowMilestone> {

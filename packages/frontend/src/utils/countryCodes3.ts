...
export const COUNTRY_ALPHA3_MAP: Record<string, string> = {
    ...
    cr: 'CRI', cu: 'CUB', cv: 'CPV', cy: 'CYP', cz: 'CZE', de: 'DEU', dj: 'DJI',
    dk: 'DNK', dm: 'DMA', do: 'DOM', dz: 'DZA', ec: 'ECU', ee: 'EST', eg: 'EGY',
    er: 'ERI', es: 'ESP', et: 'ETH', fi: 'FIN', fj: 'FJI', fm: 'FSM', fr: 'FRA',
    ...
    kr: 'KOR', kw: 'KWT', ky: 'CYM', kz: 'KAZ', la: 'LAO', lb: 'LBN', lc: 'LCA',
    li: 'LIE', lk: 'LKA', lr: 'LBR', ls: 'LSO', lt: 'LTU', lu: 'LUX', lv: 'LVA',
    ly: 'LBY', ma: 'MAR', mc: 'MCO', md: 'MDA', me: 'MNE', mg: 'MDG', mh: 'MHL',
    mk: 'MKD', ml: 'MLI', mm: 'MMR', mn: 'MNG', mo: 'MAC', mr: 'MRT', mt: 'MLT',
    mu: 'MUS', mv: 'MDV', mw: 'MWI', mx: 'MEX', my: 'MYS', mz: 'MOZ', na: 'NAM',
    ne: 'NER', ng: 'NGA', ni: 'NIC', nl: 'NLD', no: 'NOR', np: 'NPL', nr: 'NRU',
    nz: 'NZL', om: 'OMN', pa: 'PAN', pe: 'PER', pg: 'PNG', ph: 'PHL', pk: 'PAK',
    pl: 'POL', pt: 'PRT', pw: 'PLW', py: 'PRY', qa: 'QAT', ro: 'ROU', rs: 'SRB',
    ru: 'RUS', rw: 'RWA', sa: 'SAU', sb: 'SLB', sc: 'SYC', sd: 'SDN', se: 'SWE',
    sg: 'SGP', si: 'SVN', sk: 'SVK', sl: 'SLE', sm: 'SMR', sn: 'SEN', so: 'SOM',
    sr: 'SUR', ss: 'SSD', st: 'STP', sv: 'SLV', sy: 'SYR', sz: 'SWZ', td: 'TCD',
    tg: 'TGO', th: 'THA', tj: 'TJK', tl: 'TLS', tm: 'TKM', tn: 'TUN', to: 'TON',
    tr: 'TUR', tt: 'TTO', tv: 'TUV', tw: 'TWN', tz: 'TZA', ua: 'UKR', ug: 'UGA',
    us: 'USA', uy: 'URY', uz: 'UZB', ve: 'VEN', vn: 'VNM', vu: 'VUT', ws: 'WSM',

...
export function getActionLabel(
    ...
    if (!requiresApproval) {
        ...
        switch (action) {
            ...
            case 'save': return t('common.save');
    ...
    switch (action) {
        case 'create': return t('changeRequest.actions.submitCreate');
        case 'update': return t('changeRequest.actions.submitUpdate');
        case 'delete': return t('changeRequest.actions.submitDelete');
        case 'save': return t('changeRequest.actions.submitSave');
        default: return t('changeRequest.actions.submitSave');
    }
}

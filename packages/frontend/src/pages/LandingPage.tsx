      ...
      <Box
        sx={{
          ...
          '@keyframes bubbleFloat4': {
            ...
            '80%': {
              transform: 'translateY(-20px) translateX(18px) scale(0.8)',
              opacity: 0.4,
            },
            '100%': {
              transform: 'translateY(0px) translateX(0px) scale(1)',
      ...
      <Box
        sx={{
          ...
          '@keyframes bubbleFloat5': {
            ...
            '30%': {
              transform: 'translateY(-22px) translateX(-16px) scale(1.15)',
              opacity: 0.8,
            },
            '70%': {
              transform: 'translateY(16px) translateX(22px) scale(0.85)',
              opacity: 0.5,
            },
            '100%': {
              transform: 'translateY(0px) translateX(0px) scale(1)',

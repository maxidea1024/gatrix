...
const LogSidePanel = React.memo(
  React.forwardRef<HTMLDivElement, LogSidePanelProps>(
    (
      ...
      const [traceFetchedFor, setTraceFetchedFor] = useState<string | null>(
        null
      );
      ...
      if (!log && !loading) {
        return (
          ...
          >
            ...
            <Typography
              sx={{ color: 'text.secondary', fontSize: '0.8rem', mt: 4 }}
            >
              {t(
            ...
            {log && (
              <>
                <PanelHeader isDark={isDark}>
                  ...
                  <SafeTooltip
                    title={t('argus.logs.panel.close', 'Close (Esc)')}
                  >
                    ...
                    >
                      <TraceHeaderBar isDark={isDark}>
                        ...
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/argus/performance?trace=${log.trace_id}`,
                              {
                                state: { allowBack: true },
                              }
                            )
                        ...
                        >
                          {t(
                            'argus.logs.panel.viewFullTrace',
                            'View full trace'
                          )}
                        </Button>
                      </TraceHeaderBar>

...
const ChartTypeSelector: React.FC<ChartTypeSelectorProps> = ({
    ...
    () => [
      {
        ...
        label: t('argus.analytics.lineChart', 'Line Chart'),
      },
      {
        type: 'bar',
        icon: <BarIcon fontSize="small" />,
        label: t('argus.analytics.barChart', 'Bar Chart'),
      },
      {
        type: 'stacked-bar',
        icon: <StackedIcon fontSize="small" />,
        label: t('argus.analytics.stackedBar', 'Stacked Bar'),
      },
      {
        type: 'table',
        icon: <TableIcon fontSize="small" />,
        label: t('argus.analytics.tableView', 'Table'),
      },
      {
        type: 'metric',
      ...
      },
      {
        ...
        label: t('argus.analytics.donutChart', 'Donut'),
      },
    ],
    [t]
  );
  ...
  const types = availableTypes
    ...
    : ALL_CHART_TYPES.filter((ct) =>
        ['line', 'bar', 'stacked-bar', 'table'].includes(ct.type)
      );

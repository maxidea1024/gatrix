...
import { Box, Paper, Typography, IconButton, Collapse, Divider, TextField, Button, Chip, Avatar, Tooltip, alpha, useTheme } from '@mui/material';
import {
  ExpandMore as ExpandMoreIcon, Security as SecurityIcon,

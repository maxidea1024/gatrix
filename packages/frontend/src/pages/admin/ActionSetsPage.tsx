...
const ActionSetDialog: React.FC<ActionSetDialogProps> = ({
    ...
    const isValid =
        name.trim() &&
        actions.some((a) => a.params.flagName.trim() && a.params.environment.trim());
    ...
    return (
        ...
        >
                ...
                <Paper variant="outlined" sx={{ p: 2 }}>
                    ...
                    {actions.map((action, index) => (
                        <Paper
                            key={index}
                            variant="outlined"
                            sx={{ p: 2, mb: 1, display: 'flex', gap: 1, alignItems: 'flex-start', flexWrap: 'wrap' }}
                        >
            ...
            >
                ...
                <Button onClick={handleSave} variant="contained" startIcon={<SaveIcon />} disabled={!isValid}>

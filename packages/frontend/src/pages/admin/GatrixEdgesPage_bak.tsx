        ...
        <Box sx={{ p: 3, maxWidth: 1600, mx: 'auto' }}>
          ...
          */}
                    ...
                    >
                        ...
                        >
                            {groups.map((group) => (
                                <Box key={group.id} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 300 }}>
                                    {/* Connector to parent */}
                                    <Box sx={{ width: 2, height: 24, bgcolor: theme.palette.divider, mb: 1, mt: -0.5 }} />

                                    {/* Group Card */}
                                    <Card sx={{ width: '100%', mb: 2, border: `1px solid ${theme.palette.divider}` }}>
                                        <Box
                                            sx={{
                                                p: 1.5,
                                                display: 'flex',
                                                        ...
                                                        >
                                                            ...
                                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                                ...
                                                                {instance.status === 'ready' ? (
                                                                    <Chip label="Connected" size="small" color="success" sx={{ height: 20, fontSize: '0.65rem' }} />
                                                                ) : (

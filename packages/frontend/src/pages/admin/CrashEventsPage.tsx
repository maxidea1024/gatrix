...
const CrashEventsPage: React.FC = () => {
  ...
  const defaultColumns: ColumnConfig[] = [
    {
      id: 'createdAt',
      labelKey: 'crashes.table.createdAt',
      sortable: true,
      visible: true,
    },
    {
      id: 'platform',
      labelKey: 'crashes.table.platform',
      sortable: true,
      visible: true,
    },
    {
    ...
    {
      id: 'appVersion',
      labelKey: 'crashes.table.appVersion',
      sortable: true,
      visible: true,
    },
    {
      id: 'resVersion',
      labelKey: 'crashes.table.resVersion',
      sortable: true,
      visible: true,
    },
    {
      id: 'accountId',
      labelKey: 'crashes.table.accountId',
      sortable: true,
      visible: true,
    },
    {
      id: 'characterId',
      labelKey: 'crashes.table.characterId',
      sortable: true,
      visible: true,
    },
    {
      id: 'gameUserId',
      labelKey: 'crashes.table.gameUserId',
      sortable: true,
      visible: true,
    },
    {
      id: 'userName',
      labelKey: 'crashes.table.userName',
      sortable: true,
      visible: true,
    },
    {
      id: 'firstLine',
      labelKey: 'crashes.table.firstLine',
      sortable: false,
      visible: true,
    },
    {
      id: 'userMessage',
      labelKey: 'crashes.table.userMessage',
      sortable: false,
      visible: true,
    },
  ];
      ...
      if (event && event.logFilePath) {
        ...
        crashService
          ...
          .catch((error) => {
            ...
            enqueueSnackbar(t('crashes.logNotAvailable'), {
              variant: 'warning',
            });
          })
          .finally(() => {

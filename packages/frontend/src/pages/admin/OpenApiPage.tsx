...
function createClientSdkApiSpec() {
  return {
    ...
    paths: {
      ...
      '/client/remote-config/evaluate': { post: { summary: 'Evaluate remote configuration', description: 'Evaluate remote configuration with context (public endpoint)', tags: ['Configuration'], responses: { '200': { description: 'Evaluated configuration' } } } },
      ...
      '/client/remote-config/evaluate': { post: { summary: 'Evaluate configuration (authenticated)', description: 'Evaluate remote configuration with authentication', tags: ['Configuration'], security: [{ apiKeyHeader: [] }], responses: { '200': { description: 'Evaluated configuration' } } } },

...
const StrategyEditor: React.FC<StrategyEditorProps> = ({ strategy, onChange, onRemove, index, segments, contextFields }) => {
                    ...
                    <Stack spacing={2}>
                        <SegmentSelector
                            ...
                            onSegmentRemove={(segmentName) =>
                                onChange({ ...strategy, segments: (strategy.segments || []).filter((s) => s !== segmentName) })
                            }
                            t={t}
                        />
                        <Box>

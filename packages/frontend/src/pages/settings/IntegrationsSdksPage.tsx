...
const SERVER_SDKS: SdkProvider[] = [
    { name: 'nodejs', displayName: 'Node.js', type: 'Server-side', description: 'Node.js server-side SDK for Gatrix integration.', icon: nodeIcon, isServer: true },
    { name: 'java', displayName: 'Java', type: 'Server-side', description: 'Java server-side and client SDK.', icon: javaIcon, isServer: true },
    { name: 'python', displayName: 'Python', type: 'Server-side', description: 'Python server-side SDK for Gatrix integration.', icon: pythonIcon, isServer: true },
    { name: 'go', displayName: 'Go', type: 'Server-side', description: 'Go language server-side SDK.', icon: goIcon, isServer: true },
    { name: 'dotnet', displayName: '.NET', type: 'Server-side', description: '.NET server-side and client SDK.', icon: dotnetIcon, isServer: true },
    { name: 'rust', displayName: 'Rust', type: 'Server-side', description: 'High-performance Rust SDK.', icon: rustIcon, isServer: true },
    { name: 'elixir', displayName: 'Elixir', type: 'Server-side', description: 'Erlang VM (BEAM) based Elixir SDK.', icon: elixirIcon, isServer: true },
    { name: 'cpp', displayName: 'C++', type: 'Server-side', description: 'System-level C++ SDK.', icon: cppIcon, isServer: true },
    { name: 'ruby', displayName: 'Ruby', type: 'Server-side', description: 'Ruby server-side SDK for Gatrix integration.', icon: rubyIcon, isServer: true },
    { name: 'php', displayName: 'PHP', type: 'Server-side', description: 'PHP server-side SDK for Gatrix integration.', icon: phpIcon, isServer: true },
];

const WEB_SDKS: SdkProvider[] = [
    { name: 'react', displayName: 'React', type: 'Web Framework', description: 'React client-side SDK for web applications.', icon: reactIcon },
    { name: 'nextjs', displayName: 'Next.js', type: 'Web Framework', description: 'Fullstack Next.js SDK (Client/Server components).', icon: nextjsIcon },
    { name: 'vue', displayName: 'Vue.js', type: 'Web Framework', description: 'Vue.js client-side SDK for web applications.', icon: vueIcon },
    { name: 'nuxt', displayName: 'Nuxt', type: 'Web Framework', description: 'Vue-based Nuxt framework SDK.', icon: nuxtIcon },
    { name: 'svelte', displayName: 'Svelte', type: 'Web Framework', description: 'Hyper-efficient Svelte SDK.', icon: svelteIcon },
    { name: 'angular', displayName: 'Angular', type: 'Web Framework', description: 'Enterprise-grade Angular SDK.', icon: angularIcon },
    { name: 'solid', displayName: 'SolidJS', type: 'Web Framework', description: 'High-performance SolidJS SDK.', icon: solidIcon },
    { name: 'typescript', displayName: 'TypeScript', type: 'Browser', description: 'Universal TypeScript client SDK.', icon: tsIcon },
    { name: 'javascript', displayName: 'JavaScript', type: 'Browser', description: 'Universal JavaScript client SDK.', icon: jsIcon },
];

const MOBILE_SDKS: SdkProvider[] = [
    { name: 'android', displayName: 'Android', type: 'Mobile', description: 'Android native client-side SDK.', icon: androidIcon },
    { name: 'ios', displayName: 'iOS', type: 'Mobile', description: 'iOS native client-side SDK.', icon: iosIcon },
    { name: 'flutter', displayName: 'Flutter', type: 'Mobile', description: 'Flutter cross-platform client-side SDK.', icon: flutterIcon },
    { name: 'kotlin', displayName: 'Kotlin', type: 'Mobile', description: 'Kotlin Multiplatform / Native SDK.', icon: kotlinIcon },
    { name: 'swift', displayName: 'Swift', type: 'Mobile', description: 'Swift native iOS/macOS SDK.', icon: swiftIcon },
    { name: 'reactnative', displayName: 'React Native', type: 'Mobile', description: 'React Native cross-platform SDK.', icon: reactIcon },
];
        ...
        <Box sx={{ p: 3 }}>
            ...
            >
                ...
                <Typography variant="body2" color="info.main" sx={{ fontWeight: 500 }}>
                    SDK들은 현재 준비 중이며, 추후 순차적으로 공개될 예정입니다. 준비가 완료되면 문서와 함께 활성화됩니다.
                </Typography>
            </Box>

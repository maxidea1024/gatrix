...
import { applyTemplate, startMilestone } from '../../services/releaseFlowService';
            ...
            <Box sx={{ flex: '1 1 0', minWidth: 0 }}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Stepper
                    activeStep={
                      currentMilestoneIndex === -1 && plan.activeMilestoneId === 'completed'
                        ? milestones.length
                        ...
                        <StepContent>
                          ...
                          {canManage &&
                            ...
                            (index === currentMilestoneIndex ||
                              (currentMilestoneIndex === -1 && index === 0)) && (
                              <Button
                                variant="contained"
                                onClick={() => handleStartMilestone(milestone.id)}
                                disabled={startingMilestone}
                                startIcon={
                                  startingMilestone ? <CircularProgress size={16} /> : <StartIcon />
                                }
                              >

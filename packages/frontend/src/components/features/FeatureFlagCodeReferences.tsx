...
const FeatureFlagCodeReferences: React.FC<FeatureFlagCodeReferencesProps> = ({
  ...
  return (
    <Box>
      <Box
        sx={{ mb: 2, display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 2 }}
      >
        {scanInfo && (
          <Box
            sx={{
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    textDecoration:
                      references.length > 0 && references[0].codeUrl ? 'underline' : 'none',
                    color:
                      references.length > 0 && references[0].codeUrl ? 'primary.main' : 'inherit',
                  }}
                >
      ...
      {references.length === 0 ? (
        ...
        >
          <CodeIcon
            sx={{ fontSize: 48, color: 'text.disabled', display: 'block', mx: 'auto', mb: 2 }}
          />
        </EmptyPlaceholder>
      ) : (
              ...
              {references.map((ref) => (
                <React.Fragment key={ref.id}>
                  <TableRow hover>
                    ...
                    <TableCell>
                      <Tooltip
                        title={t('featureFlags.codeReferences.confidenceLevel', {

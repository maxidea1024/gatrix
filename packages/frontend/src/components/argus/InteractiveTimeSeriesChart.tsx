...
ChartJS.register(
  CategoryScale, LinearScale, LogarithmicScale, PointElement, LineElement, BarElement,
...
const InteractiveTimeSeriesChart: React.FC<InteractiveTimeSeriesChartProps> = ({
  ...
  return (
    <Box sx={{ height, position: 'relative', width: '100%' }}>
      <Chart type="bar" data={chartData as any} options={options as any} plugins={plugins} />
    </Box>
  );
};

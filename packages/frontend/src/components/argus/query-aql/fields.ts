...
export const USER_PROFILES_CONFIG: DomainConfig = {
  name: 'user_profiles',
  fields: [
    {
      key: 'user_id',
    ...
    },
    {
      ...
      description: 'Device operating system or platform',
    },
    {
      key: 'country',
      label: 'Country',
    ...
    },
    {
      ...
      searchable: false,
      category: 'user',
      staticValues: ['none', 'low', 'medium', 'high', 'churned'],
      description: 'Predicted risk of user churning',
    },
    {
      key: 'net_revenue',
      label: 'Revenue',
    ...
    },
    {
      ...
      searchable: false,
      category: 'user',
      description: 'Total events logged for user',
    },
    {
      key: 'total_sessions',
      label: 'Sessions',
      ...
      searchable: false,
      category: 'user',
      description: 'Total sessions completed by user',
    },
    {
      key: 'days_inactive',
      label: 'Inactive Days',

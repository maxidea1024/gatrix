 ...
 */
const DiscoverFacetMap: React.FC<DiscoverFacetMapProps> = ({
  facets,
  onSelectFacet,
  loading,
}) => {
                  ...
                  >
                    ...
                    >
                      <IconButton
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          onSelectFacet(activeTag!, v.value, false);
                          setAnchorEl(null);
                          setActiveTag(null);
                        }}
                    ...
                    <Tooltip
                      title={t('argus.discover.facet.exclude', 'Exclude')}
                    >
                      <IconButton
                        size="small"
                        onClick={(e) => {
                          e.stopPropagation();
                          onSelectFacet(activeTag!, v.value, true);
                          setAnchorEl(null);
                          setActiveTag(null);
                        }}

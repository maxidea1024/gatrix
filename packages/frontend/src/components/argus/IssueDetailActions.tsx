    ...
    <>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
        ...
        <Tooltip
          title={
            isSubscribed
              ? t('argus.detail.unsubscribe')
              : t('argus.detail.subscribe')
          }
        >
          <IconButton
            size="small"
          ...
          >
            {isSubscribed ? (
              <SubscribeIcon sx={{ fontSize: 16 }} />
            ) : (
              <UnsubscribeIcon sx={{ fontSize: 16 }} />
            )}
          </IconButton>
        </Tooltip>
        ...
        <Tooltip
          title={
            isBookmarked
              ? t('argus.detail.removeBookmark')
              : t('argus.detail.bookmark')
          }
        >
          <IconButton
            size="small"
        ...
        {onToggleSidebar && (
          <Tooltip
            title={
              sidebarCollapsed
                ? t('argus.detail.expandSidebar', '사이드바 열기')
                : t('argus.detail.collapseSidebar', '사이드바 닫기')
            }
          >
            <IconButton
              size="small"
      ...
      >
        ...
        >
          <ListItemIcon>
            <DiscardIcon fontSize="small" sx={{ color: 'warning.main' }} />
          </ListItemIcon>
          <ListItemText
      ...
      >
        <DialogTitle sx={{ fontWeight: 700 }}>
          {t('argus.detail.deleteConfirmTitle')}
        </DialogTitle>
        <DialogContent>
      ...
      >
        <DialogTitle sx={{ fontWeight: 700 }}>
          {t('argus.detail.discardConfirmTitle')}
        </DialogTitle>
        <DialogContent>
          <DialogContentText sx={{ fontSize: '0.85rem' }}>

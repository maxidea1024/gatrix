...
const ClientVersionGuideDrawer: React.FC<ClientVersionGuideDrawerProps> = ({
  open,
  onClose,
}) => {
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "clientVersionGuideDrawer_testInputs",
        JSON.stringify({
          apiToken,
          platform,
          version,
...
curl -X GET "${backendUrl}/api/v1/client/${currentEnvironmentId || "your-environment"}/client-version?platform=ios&status=ONLINE" \\
  ...
  const handleTestAPI = async () => {
    ...
    if (!platform.trim()) {
      setValidationError(
        t("clientVersions.sdkGuideDrawer.platformRequired") ||
    ...
    if (!apiToken.trim()) {
      setValidationError(
        t("clientVersions.sdkGuideDrawer.apiTokenRequired") ||
            ...
            <>
              ...
              >
                <Typography component="div" sx={{ mb: 1 }}>
                  <strong>{t("clientVersions.sdkGuideDrawer.method")}:</strong>{" "}
                  GET
                </Typography>
              ...
              <Stack spacing={1} sx={{ mb: 3 }}>
                <Typography variant="body2">
                  • <strong>platform</strong> (required):{" "}
                  {t("clientVersions.sdkGuideDrawer.paramPlatform")}
                </Typography>
                <Typography variant="body2">
                  • <strong>version</strong> (required):{" "}
                  {t("clientVersions.sdkGuideDrawer.paramClientVersion")}
                </Typography>
                <Typography variant="body2">
                  • <strong>lang</strong> (optional):{" "}
                  {t("clientVersions.sdkGuideDrawer.paramLang")}
                </Typography>
              </Stack>
              ...
              <Stack spacing={1} sx={{ mb: 3 }}>
                <Typography variant="body2">
                  ...
                  {t("clientVersions.sdkGuideDrawer.headerAppName")}
                </Typography>
                <Typography variant="body2">
                  • <strong>X-API-Token</strong>:{" "}
                  {t("clientVersions.sdkGuideDrawer.headerApiToken")}
                </Typography>
                <Typography variant="body2">
                  • <strong>Content-Type</strong>:{" "}
                  {t("clientVersions.sdkGuideDrawer.headerContentType")}
                </Typography>
              </Stack>
                ...
                <Table size="small">
                  <TableHead>
                    ...
                    >
                      ...
                      <TableCell sx={{ fontWeight: 600, width: "35%" }}>
                        {t(
                          "clientVersions.sdkGuideDrawer.statusTableDescription",
                        )}
                      </TableCell>
                      <TableCell sx={{ fontWeight: 600, width: "50%" }}>
                        {t(
                          "clientVersions.sdkGuideDrawer.statusTableClientAction",
                        )}
                      </TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t("clientVersions.sdkGuideDrawer.statusOnline")}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusOnlineAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t("clientVersions.sdkGuideDrawer.statusMaintenance")}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusMaintenanceAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t("clientVersions.sdkGuideDrawer.statusOffline")}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusOfflineAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusRecommendedUpdate",
                          )}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusRecommendedUpdateAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusForcedUpdate",
                          )}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusForcedUpdateAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusBlockedPatchAllowed",
                          )}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusBlockedPatchAllowedAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="body2">
                          {t("clientVersions.sdkGuideDrawer.statusUnderReview")}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">
                          {t(
                            "clientVersions.sdkGuideDrawer.statusUnderReviewAction",
                          )}
                        </Typography>
                      </TableCell>
                    </TableRow>
                        ...
                        >
                          ...
                          >
                            <TextField
                              ...
                              fullWidth
                              placeholder={t(
                                "clientVersions.sdkGuideDrawer.versionPlaceholder",
                              )}
                              sx={{
                                "& .MuiInputBase-root": {
                                  fontSize: "0.875rem",
                          ...
                          >
                            <FormControl size="small" fullWidth>
                              ...
                              >
                                <MenuItem value="">
                                  {t(
                                    "clientVersions.sdkGuideDrawer.statusNone",
                                  )}
                                </MenuItem>
                                ...
                                <MenuItem value="RECOMMENDED_UPDATE">
                                  RECOMMENDED_UPDATE
                                </MenuItem>
                                <MenuItem value="FORCED_UPDATE">
                                  FORCED_UPDATE
                                </MenuItem>
                                <MenuItem value="UNDER_REVIEW">
                                  UNDER_REVIEW
                                </MenuItem>
                                <MenuItem value="BLOCKED_PATCH_ALLOWED">
                                  BLOCKED_PATCH_ALLOWED
                                </MenuItem>
                              </Select>
                            </FormControl>
                      ...
                      >
                        ...
                        <Tooltip title={t("common.copy") || "Copy"}>
                          <IconButton
                            size="small"
                            onClick={() =>
                              handleCopyCode(`curl -X GET "${backendUrl}/api/v1/client/${currentEnvironmentId || "your-environment"}/client-version?platform=${platform}${version ? `&version=${version}` : ""}${status ? `&status=${status}` : ""}${lang ? `&lang=${lang}` : ""}" \\
  -H "Content-Type: application/json" \\
                      ...
                      {testStatus && (
                        <Box sx={{ display: "flex", gap: 2 }}>
                          <Box>
                            ...
                            >
                              {t("clientVersions.sdkGuideDrawer.status")}
                            </Typography>
                            <Typography
                              variant="body2"
                              sx={{ fontWeight: 600 }}
                          ...
                          {testDuration !== null && (
                            <Box>
                              <Typography
                                ...
                                sx={{ color: "text.secondary" }}
                              >
                                {t("clientVersions.sdkGuideDrawer.time")}
                              </Typography>
                              <Typography
                                variant="body2"
                                sx={{ fontWeight: 600 }}
                          ...
                          {Object.keys(responseHeaders).length > 0 && (
                            <Box>
                              <Typography
                                ...
                                sx={{ color: "text.secondary" }}
                              >
                                {t("clientVersions.sdkGuideDrawer.size")}
                              </Typography>
                              <Typography
                                variant="body2"
                                sx={{ fontWeight: 600 }}

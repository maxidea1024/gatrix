...
const ContextFieldChip: React.FC<ContextFieldChipProps> = ({
    ...
    return (
        <>
            <Tooltip title={fieldInfo ? t('playground.viewFieldInfo') : ''} disableHoverListener={!fieldInfo}>
                <Chip
                    label={chipLabel}
                    size="small"
                    variant="outlined"
                    ...
                    <Box sx={{ p: 2 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1.5 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                <FieldTypeIcon type={fieldInfo.fieldType} sx={{ fontSize: 18, color: 'primary.main' }} />
                                    ...
                                    <tbody>
                                        {fieldInfo.validationRules.isRequired && (
                                            <tr>
                                                ...
                                                <td><Typography component="span" variant="caption" color="error.main" fontWeight={600}>{t('common.yes')}</Typography></td>
                                            </tr>
                                        )}
                                        {fieldInfo.validationRules.legalValues && fieldInfo.validationRules.legalValues.length > 0 && (
                                            <tr>
                                        ...
                                        {fieldInfo.validationRules.pattern && (() => {
                                            ...
                                            return (
                                                <tr>
                                                    ...
                                                    <td><code style={{ fontSize: '0.7rem' }}>{fieldInfo.validationRules!.pattern}</code></td>
                                                </tr>
                                            );
                                        })()}
                                        ...
                                        {fieldInfo.validationRules.integerOnly && (
                                            <tr>
                                                ...
                                                <td><Typography component="span" variant="caption" color="primary.main" fontWeight={600}>{t('common.yes')}</Typography></td>
                                            </tr>
                                        )}
                                        {fieldInfo.validationRules.trimWhitespace && fieldInfo.validationRules.trimWhitespace !== 'none' && (
                                            <tr>

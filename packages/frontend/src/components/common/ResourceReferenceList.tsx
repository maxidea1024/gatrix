                ...
                <Box>
                    ...
                    <TableContainer sx={{ border: 1, borderColor: 'divider', borderRadius: 1 }}>
                        <Table size="small">
                            <TableHead>
                                <TableRow sx={{ bgcolor: 'action.hover' }}>
                                    <TableCell sx={{ fontWeight: 600, py: 0.75 }}>{t('featureFlags.segmentName')}</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                ...
                <Box>
                    ...
                    <TableContainer sx={{ border: 1, borderColor: 'divider', borderRadius: 1 }}>
                        <Table size="small">
                            <TableHead>
                                <TableRow sx={{ bgcolor: 'action.hover' }}>
                                    <TableCell sx={{ fontWeight: 600, py: 0.75 }}>{t('releaseFlow.flowName')}</TableCell>
                                    <TableCell sx={{ fontWeight: 600, py: 0.75 }}>{t('releaseFlow.milestoneName')}</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>

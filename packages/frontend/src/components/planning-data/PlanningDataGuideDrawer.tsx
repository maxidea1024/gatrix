...
const CodeBlock: React.FC<{
  ...
  onCopy: () => void;
  height?: number;
}> = ({ code, language = 'shell', onCopy, height = 120 }) => {
        ...
        <Typography variant="body2" component="div">
          ...
          <Box component="ul" sx={{ m: 0, pl: 2 }}>
            <li>
              ...
              {t('planningData.uploadGuide.binaryCodeDesc') ||
                'CMS file suffix (default: cn → uses CashShop_BCCN.json)'}
            </li>
            <li>
              <code>--country-code</code>:{' '}
              {t('planningData.uploadGuide.countryCodeDesc') ||
                'Filtering mask (default: 6=CHINA, 0=KOREA, 2=GLOBAL)'}
            </li>
          </Box>
        </Typography>
      </Alert>

...
const SUPPORTED_FILES = [
  // Reward data
  {
    ...
    category: 'Reward',
    description: 'Reward type list',
  },
  {
    name: 'reward-lookup-kr.json',
    category: 'Reward',
    description: 'Reward lookup (Korean)',
  },
  {
    name: 'reward-lookup-en.json',
    category: 'Reward',
    description: 'Reward lookup (English)',
  },
  {
    name: 'reward-lookup-zh.json',
    category: 'Reward',
    description: 'Reward lookup (Chinese)',
  },
  // UI data
  {
    name: 'ui-list-data-kr.json',
    category: 'UI',
    description: 'UI list data (Korean)',
  },
  {
    name: 'ui-list-data-en.json',
    category: 'UI',
    description: 'UI list data (English)',
  },
  {
    name: 'ui-list-data-zh.json',
    category: 'UI',
    description: 'UI list data (Chinese)',
  },
  ...
  {
    name: 'eventpage-lookup-kr.json',
    category: 'Event',
    description: 'EventPage (Korean)',
  },
  {
    name: 'eventpage-lookup-en.json',
    category: 'Event',
    description: 'EventPage (English)',
  },
  {
    name: 'eventpage-lookup-zh.json',
    category: 'Event',
    description: 'EventPage (Chinese)',
  },
  // Event data - LiveEvent
  {
    name: 'liveevent-lookup-kr.json',
    category: 'Event',
    description: 'LiveEvent (Korean)',
  },
  {
    name: 'liveevent-lookup-en.json',
    category: 'Event',
    description: 'LiveEvent (English)',
  },
  {
    name: 'liveevent-lookup-zh.json',
    category: 'Event',
    description: 'LiveEvent (Chinese)',
  },
...
export const PlanningDataUpload: React.FC<PlanningDataUploadProps> = ({
  onUploadSuccess,
  onClose,
}) => {
  ...
  return (
    <Box>
          ...
          {selectedFiles.length > 0 && (
            <Box sx={{ mb: 2 }}>
              ...
              <TextField
                ...
                placeholder={
                  t('planningData.upload.commentPlaceholder') ||
                  'Optional comment about this upload'
                }
                value={uploadComment}
      ...
      >
        ...
        <DialogContent>
          <Typography>
            {t('planningData.upload.alreadyUpToDate') ||
              'The data is already up to date. No changes were detected.'}
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
            {t('planningData.upload.forceUploadHint') ||
              'If you want to re-upload the data anyway, use the Force Upload button.'}
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button
          ...
          {previewResult && (
            <Box>
              ...
              {previewResult.changedFiles.length === 0 ? (
                <Alert severity="info">
                  {t('planningData.upload.noChangesDetected') ||
                    'No changes detected. The data is already up to date.'}
                </Alert>
              ) : (
                <Box>

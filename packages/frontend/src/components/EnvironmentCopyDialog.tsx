      ...
      <DialogContent dividers>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 3 }}>
          <FormControl fullWidth>
            ...
            >
              {environments.map((env) => (
                <MenuItem key={env.environment} value={env.environment} disabled={env.environment === targetId}>
                  {env.displayName}
                </MenuItem>
              ))}
            </Select>
          ...
          <FormControl fullWidth>
            ...
            >
              {environments.map((env) => (
                <MenuItem key={env.environment} value={env.environment} disabled={env.environment === sourceId}>
                  {env.displayName}
                </MenuItem>
              ))}
            </Select>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0.5 }}>
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyTemplates} onChange={(e) => setOptions({ ...options, copyTemplates: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyTemplates')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyGameWorlds} onChange={(e) => setOptions({ ...options, copyGameWorlds: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyGameWorlds')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copySegments} onChange={(e) => setOptions({ ...options, copySegments: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copySegments')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyBanners} onChange={(e) => setOptions({ ...options, copyBanners: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyBanners')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyClientVersions} onChange={(e) => setOptions({ ...options, copyClientVersions: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyClientVersions')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyCoupons} onChange={(e) => setOptions({ ...options, copyCoupons: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyCoupons')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyIngamePopupNotices} onChange={(e) => setOptions({ ...options, copyIngamePopupNotices: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyIngamePopupNotices')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyMessageTemplates} onChange={(e) => setOptions({ ...options, copyMessageTemplates: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyMessageTemplates')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyRewardTemplates} onChange={(e) => setOptions({ ...options, copyRewardTemplates: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyRewardTemplates')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyServiceMaintenance} onChange={(e) => setOptions({ ...options, copyServiceMaintenance: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyServiceMaintenance')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyServiceNotices} onChange={(e) => setOptions({ ...options, copyServiceNotices: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyServiceNotices')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copySurveys} onChange={(e) => setOptions({ ...options, copySurveys: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copySurveys')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyVars} onChange={(e) => setOptions({ ...options, copyVars: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyVars')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyContextFields} onChange={(e) => setOptions({ ...options, copyContextFields: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyContextFields')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyCampaigns} onChange={(e) => setOptions({ ...options, copyCampaigns: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyCampaigns')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyAccountWhitelist} onChange={(e) => setOptions({ ...options, copyAccountWhitelist: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyAccountWhitelist')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyIpWhitelist} onChange={(e) => setOptions({ ...options, copyIpWhitelist: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyIpWhitelist')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyJobs} onChange={(e) => setOptions({ ...options, copyJobs: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyJobs')}</Typography>}
            />
            <FormControlLabel
              control={<Checkbox size="small" checked={options.copyPlanningData} onChange={(e) => setOptions({ ...options, copyPlanningData: e.target.checked })} disabled={copying} />}
              label={<Typography variant="body2">{t('environments.copyPlanningData')}</Typography>}
            />
          </Box>
          <Divider sx={{ my: 1 }} />
          <FormControlLabel
            control={<Checkbox checked={options.overwriteExisting} onChange={(e) => setOptions({ ...options, overwriteExisting: e.target.checked })} disabled={copying} />}
            label={
              <Box>
                <Typography variant="body2">{t('environments.overwriteExisting')}</Typography>
                <Typography variant="caption" color="text.secondary">{t('environments.overwriteExistingDescription')}</Typography>
              </Box>
            }
          />
        </Box>
                  ...
                  return (
                    <TableRow key={key}>
                      ...
                      <TableCell align="right">
                        {summary.conflicts > 0 ? (
                          <Chip size="small" color="warning" icon={<WarningIcon />} label={summary.conflicts} />
                        ) : (
                          <Chip size="small" color="success" label={t('environments.noConflicts')} />
                        )}
                      </TableCell>
                    </TableRow>
                  );
              ...
              {[
                ...
                return (
                  <Typography key={key} variant="body2">
                    {t(`environments.${label}`)}: {item.copied} {t('environments.copied')}, {item.skipped} {t('environments.skipped')}
                  </Typography>
                );
              })}
            </Box>

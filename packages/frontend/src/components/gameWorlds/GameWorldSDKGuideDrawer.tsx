                    ...
                    {[
                      {
                        field: 'worldId',
                        type: 'string',
                        desc: 'fieldWorldIdDesc',
                      },
                      { field: 'name', type: 'string', desc: 'fieldNameDesc' },
                      {
                        field: 'isMaintenance',
                        type: 'boolean',
                        desc: 'fieldIsMaintenanceDesc',
                      },
                      {
                        field: 'maintenanceMessage',
                        type: 'string',
                        desc: 'fieldMaintenanceMessageDesc',
                      },
                      {
                        field: 'worldServerAddress',
                        type: 'string',
                        desc: 'fieldWorldServerAddressDesc',
                      },
                      {
                        field: 'customPayload',
                        type: 'object',
                        desc: 'fieldCustomPayloadDesc',
                      },
                      ...
                      >
                        ...
                        <Tooltip title={t('common.copy') || 'Copy'}>
                          <IconButton
                            size="small"
                            onClick={() =>
                              handleCopyCode(`curl -X GET "${backendUrl}/api/v1/server/${currentEnvironmentId || 'your-environment'}/game-worlds${lang ? `?lang=${lang}` : ''}" \\
  -H "Content-Type: application/json" \\

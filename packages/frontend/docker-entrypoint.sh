...
EDGE_URL=${VITE_EDGE_URL:-""}
GRAFANA_URL=${VITE_GRAFANA_URL:-""}
BULL_BOARD_URL=${VITE_BULL_BOARD_URL:-""}
...
echo "  BULL_BOARD_URL: $BULL_BOARD_URL"
...
window.ENV = {
  ...
  VITE_EDGE_URL: '$EDGE_URL',
  VITE_GRAFANA_URL: '$GRAFANA_URL',
  VITE_BULL_BOARD_URL: '$BULL_BOARD_URL'
};
EOF

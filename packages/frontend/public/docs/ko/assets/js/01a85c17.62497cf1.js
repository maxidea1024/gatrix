  ...
  [8209],
  {
    4096(e, t, a) {
      ...
      function f() {
        ...
        return {
          ...
          ...p(f, n, r),
          ...(x ? { keywords: x } : {}),
          isPartOf: { '@type': 'Blog', '@id': `${s.url}${e.blogBasePath}`, name: e.blogTitle },
        };
      }
      function x(e) {
        return {
    ...
    8027(e, t, a) {
      ...
      function u({ year: e, yearGroupHeadingClassName: t, children: a }) {
        return (0, d.jsxs)('div', {
          role: 'group',
          children: [(0, d.jsx)(m.A, { as: 'h3', className: t, children: e }), a],
        });
      }
        ...
        if ((0, c.p)().blog.sidebar.groupByYear) {
          ...
          return (0, d.jsx)(d.Fragment, {
            children: s.map(([e, s]) =>
              (0, d.jsx)(
                u,
                { year: e, yearGroupHeadingClassName: t, children: (0, d.jsx)(a, { items: s }) },
                e
              )
            ),
          });
      ...
      function k({ sidebar: e }) {
        ...
        return (0, d.jsx)('aside', {
          ...
          children: (0, d.jsxs)('nav', {
            ...
            children: [
              (0, d.jsx)('div', { className: (0, n.A)(b, 'margin-bottom--md'), children: e.title }),
              (0, d.jsx)(h, { items: t, ListComponent: C, yearGroupHeadingClassName: v }),
            ],
          }),
        });
      }
      ...
      function w({ sidebar: e }) {
        const t = (0, o.Gx)(e.items);
        return (0, d.jsx)(h, { items: t, ListComponent: _, yearGroupHeadingClassName: P });
      }
      function B(e) {
        return (0, d.jsx)(y.GX, { component: w, props: e });
      }
      const G = (0, s.memo)(B);
    ...
    9158(e, t, a) {
      ...
      const m = 'tag_Nnez';
      var d = a(4848);
      function u({ letterEntry: e }) {
        return (0, d.jsxs)('article', {
          children: [
            (0, d.jsx)(c.A, { as: 'h2', id: e.letter, children: e.letter }),
            (0, d.jsx)('ul', {
              className: 'padding--none',
              children: e.tags.map((e) =>
                (0, d.jsx)('li', { className: m, children: (0, d.jsx)(o.A, { ...e }) }, e.permalink)
              ),
            }),
            (0, d.jsx)('hr', {}),
          ],
      ...
      function g({ tags: e }) {
        ...
        return (0, d.jsx)('section', {
          ...
          children: t.map((e) => (0, d.jsx)(u, { letterEntry: e }, e.letter)),
        });
      }
      var h = a(1463);
      function p({ tags: e, sidebar: t }) {
        const a = (0, n.T)({
          id: 'theme.tags.tagsPageTitle',
          message: 'Tags',
          description: 'The title of the tag list page',
        });
        return (0, d.jsxs)(i.e3, {
          className: (0, s.A)(r.G.wrapper.blogPages, r.G.page.blogTagsListPage),
          children: [
            (0, d.jsx)(i.be, { title: a }),
            (0, d.jsx)(h.A, { tag: 'blog_tags_list' }),
            (0, d.jsxs)(l.A, {
              sidebar: t,
              children: [(0, d.jsx)(c.A, { as: 'h1', children: a }), (0, d.jsx)(g, { tags: e })],
            }),
          ],
        });
      }

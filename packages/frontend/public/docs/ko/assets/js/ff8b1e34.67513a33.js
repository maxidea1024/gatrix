...
(globalThis.webpackChunkdocs = globalThis.webpackChunkdocs || []).push([
  [6774],
  {
    ...
    9026(e, n, s) {
      ...
      const r = JSON.parse(
        '{"id":"deployment/docker","title":"Docker Deployment Guide","description":"This page explains how to run Gatrix with Docker in both development and production-like environments.","source":"@site/docs/deployment/docker.md","sourceDirName":"deployment","slug":"/deployment/docker","permalink":"/docs/ko/deployment/docker","draft":false,"unlisted":false,"editUrl":"https://github.com/your-org/gatrix/tree/main/docs/docs/deployment/docker.md","tags":[],"version":"current","sidebarPosition":50,"frontMatter":{"slug":"/deployment/docker","title":"Docker Deployment Guide","sidebar_position":50},"sidebar":"tutorialSidebar","previous":{"title":"\uc11c\ubc84 SDK API","permalink":"/docs/ko/api/server-sdk-api"},"next":{"title":"Edge Server Guide","permalink":"/docs/ko/deployment/edge-server"}}'
      );
      var i = s(4848),
        d = s(8453);
      const l = {

/*! For license information please see main.ff92c4b5.js.LICENSE.txt */
  ...
  [8792],
  {
    ...
    8328(e, t, n) {
      ...
      const f = [
        ...
        {
          path: '/docs/ko/',
          component: d('/docs/ko/', '52d'),
          routes: [
            {
              path: '/docs/ko/',
              component: d('/docs/ko/', 'e51'),
              routes: [
                {
                  path: '/docs/ko/',
                  component: d('/docs/ko/', '2bf'),
                  routes: [
                    {

/*! For license information please see main.7c5c3195.js.LICENSE.txt */
  ...
  [8792],
  {
    ...
    8328(e, t, n) {
      ...
      const p = [
        ...
        {
          path: '/docs/zh-Hans/',
          component: d('/docs/zh-Hans/', '772'),
          routes: [
            {
              path: '/docs/zh-Hans/',
              component: d('/docs/zh-Hans/', 'fa4'),
              routes: [
                {
                  path: '/docs/zh-Hans/',
                  component: d('/docs/zh-Hans/', 'd99'),
                  routes: [
                    {

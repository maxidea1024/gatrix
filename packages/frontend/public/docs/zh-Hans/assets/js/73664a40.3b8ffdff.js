      ...
      function c(e) {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            ...
            '\n',
            (0, a.jsx)(t.p, { children: 'The job management system provides:' }),
            '\n',
            (0, a.jsxs)(t.ul, {
              children: [
                '\n',
                (0, a.jsxs)(t.li, {
                  children: [
                    (0, a.jsx)(t.strong, { children: 'Multiple Job Types' }),
                ...
                (0, a.jsxs)(t.li, {
                  children: [
                    (0, a.jsx)(t.strong, { children: 'Queue Management' }),
                ...
                (0, a.jsxs)(t.li, {
                  children: [
                    (0, a.jsx)(t.strong, { children: 'Real-time Monitoring' }),
                ...
                (0, a.jsxs)(t.li, {
                  children: [
                    (0, a.jsx)(t.strong, { children: 'Retry Mechanisms' }),
            ...
            '\n',
            (0, a.jsx)(t.h2, { id: '-job-types', children: '\ud83d\udce6 Job Types' }),
            '\n',
            (0, a.jsxs)(t.h3, {
              id: '1-email-jobs-mailsend',
              children: ['1. Email Jobs (', (0, a.jsx)(t.code, { children: 'mailsend' }), ')'],
            }),
            '\n',
            (0, a.jsx)(t.p, { children: 'Send automated emails with template support.' }),
            '\n',
            (0, a.jsxs)(t.h3, {
              id: '2-http-request-jobs-http_request',
              children: [
                '2. HTTP Request Jobs (',
                (0, a.jsx)(t.code, { children: 'http_request' }),
                ')',
              ],
            }),
            '\n',
            (0, a.jsx)(t.p, { children: 'Execute webhooks or API calls.' }),
            '\n',
            (0, a.jsxs)(t.h3, {
              id: '3-ssh-command-jobs-ssh_command',
              children: [
                '3. SSH Command Jobs (',
                (0, a.jsx)(t.code, { children: 'ssh_command' }),
                ')',
              ],
            }),
            '\n',
            (0, a.jsx)(t.p, { children: 'Run commands on remote servers securely.' }),
            '\n',
            ...
            (0, a.jsxs)(t.p, {
              children: [
                ...
                (0, a.jsx)(t.code, { children: '/admin/queues' }),

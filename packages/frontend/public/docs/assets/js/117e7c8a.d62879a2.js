...
(globalThis.webpackChunkdocs = globalThis.webpackChunkdocs || []).push([
  [8506],
  {
    3892(e, n, a) {
      ...
      const t = JSON.parse(
        '{"id":"api/server-sdk-api","title":"Server SDK API","description":"SDK for game servers to integrate with Gatrix.","source":"@site/docs/api/server-sdk-api.md","sourceDirName":"api","slug":"/api/server-sdk-api","permalink":"/docs/api/server-sdk-api","draft":false,"unlisted":false,"editUrl":"https://github.com/your-org/gatrix/tree/main/docs/docs/api/server-sdk-api.md","tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_position":2,"sidebar_label":"Server SDK API"},"sidebar":"tutorialSidebar","previous":{"title":"Client API","permalink":"/docs/api/client-api"},"next":{"title":"Docker Deployment Guide","permalink":"/docs/deployment/docker"}}'
      );
      var r = a(4848),
        i = a(8453);
      const s = { sidebar_position: 2, sidebar_label: 'Server SDK API' },
        l = 'Server SDK API',
        c = {},
        d = [
          { value: 'Installation', id: 'installation', level: 2 },
          { value: 'Initialization', id: 'initialization', level: 2 },
          { value: 'Feature Flags', id: 'feature-flags', level: 2 },
          { value: 'Get Boolean Value', id: 'get-boolean-value', level: 3 },
          { value: 'Get String Value', id: 'get-string-value', level: 3 },
          { value: 'Get Number Value', id: 'get-number-value', level: 3 },
          { value: 'Get JSON Value', id: 'get-json-value', level: 3 },
          { value: 'Get All Flags', id: 'get-all-flags', level: 3 },
          { value: 'Maintenance', id: 'maintenance', level: 2 },
          { value: 'Check Status', id: 'check-status', level: 3 },
          { value: 'Whitelist', id: 'whitelist', level: 2 },
          { value: 'Check Account', id: 'check-account', level: 3 },
          { value: 'Check IP', id: 'check-ip', level: 3 },
          { value: 'Game Worlds', id: 'game-worlds', level: 2 },
          { value: 'Register Instance', id: 'register-instance', level: 3 },
          { value: 'Update Status', id: 'update-status', level: 3 },
          { value: 'Events', id: 'events', level: 2 },
          { value: 'Send Event', id: 'send-event', level: 3 },
      ...
      function o(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)(n.header, {
              children: (0, r.jsx)(n.h1, { id: 'server-sdk-api', children: 'Server SDK API' }),
            }),
            '\n',
            ...
            (0, r.jsx)(n.pre, {
              children: (0, r.jsx)(n.code, {
                ...
                children: 'npm install @gatrix/server-sdk\n# or\nyarn add @gatrix/server-sdk\n',
              }),
            }),
            '\n',
            ...
            (0, r.jsx)(n.pre, {
              children: (0, r.jsx)(n.code, {
                className: 'language-typescript',
                children: 'const allFlags = await gatrix.featureFlags.getAllFlags(context);\n',
              }),
            }),
            '\n',

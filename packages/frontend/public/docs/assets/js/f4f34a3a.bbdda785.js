  ...
  [3637],
  {
    1470(e, t, a) {
      ...
      function g(e) {
        const { defaultValue: t, queryString: a = !1, groupId: n } = e,
          ...
          f = (() => {
            const e = u ?? g;
            return m({ value: e, tabValues: s }) ? e : null;
          })();
        (0, o.A)(() => {
          f && l(f);
        }, [f]);
    ...
    1632(e) {
      e.exports = JSON.parse(
        '{"permalink":"/docs/blog/real-time-chat-server-setup","editUrl":"https://github.com/your-org/gatrix/tree/main/docs/blog/2021-08-01-mdx-blog-post.mdx","source":"@site/blog/2021-08-01-mdx-blog-post.mdx","title":"Gatrix Real-time Chat Server Setup Guide","description":"Gatrix\'s real-time chat server uses Socket.IO and Redis clustering to provide high-performance messaging. This guide will walk you through setting up and optimizing the chat server step by step.","date":"2021-08-01T00:00:00.000Z","tags":[{"inline":false,"label":"Gatrix","permalink":"/docs/blog/tags/gatrix","description":"Gatrix game platform management system"},{"inline":false,"label":"Chat","permalink":"/docs/blog/tags/chat","description":"Real-time chat server features"},{"inline":false,"label":"Tutorial","permalink":"/docs/blog/tags/tutorial","description":"Step-by-step tutorials and guides"},{"inline":false,"label":"Setup","permalink":"/docs/blog/tags/setup","description":"Installation and configuration guides"}],"readingTime":1.62,"hasTruncateMarker":true,"authors":[{"name":"Gatrix Team","title":"Game Platform Development Team","url":"https://github.com/your-org/gatrix","page":{"permalink":"/docs/blog/authors/gatrix-team"},"socials":{"github":"https://github.com/your-org","email":"mailto:support@gatrix.com"},"imageURL":"https://avatars.githubusercontent.com/u/0?v=4","key":"gatrix-team"}],"frontMatter":{"slug":"real-time-chat-server-setup","title":"Gatrix Real-time Chat Server Setup Guide","authors":["gatrix-team"],"tags":["gatrix","chat","tutorial","setup"]},"unlisted":false,"prevItem":{"title":"Gatrix API Integration and Webhook Setup Guide","permalink":"/docs/blog/api-integration-webhooks"},"nextItem":{"title":"Mastering Gatrix Job Management System","permalink":"/docs/blog/mastering-job-management-system"}}'
      );
    },
    5512(e, t, a) {
      (a.r(t),

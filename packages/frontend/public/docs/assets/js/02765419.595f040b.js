...
(globalThis.webpackChunkdocs = globalThis.webpackChunkdocs || []).push([
  [6343],
  {
    6374(e, s, r) {
      ...
      const n = JSON.parse(
        '{"id":"sdks/server-side","title":"Server-side SDKs","description":"Gatrix provides various server-side SDKs to integrate feature flagging into your backend services with high performance and reliability.","source":"@site/docs/sdks/server-side.md","sourceDirName":"sdks","slug":"/sdks/server-side","permalink":"/docs/sdks/server-side","draft":false,"unlisted":false,"editUrl":"https://github.com/your-org/gatrix/tree/main/docs/docs/sdks/server-side.md","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1},"sidebar":"tutorialSidebar","previous":{"title":"New Relic","permalink":"/docs/integrations/new-relic"},"next":{"title":"Client-side SDKs","permalink":"/docs/sdks/client-side"}}'
      );
      var i = r(4848),
        t = r(8453);

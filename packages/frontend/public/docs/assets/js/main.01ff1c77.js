/*! For license information please see main.01ff1c77.js.LICENSE.txt */
  ...
  [8792],
  {
    ...
    8328(e, t, n) {
      ...
      const f = [
        ...
        {
          path: '/docs/',
          component: d('/docs/', 'c0b'),
          routes: [
            {
              path: '/docs/',
              component: d('/docs/', '44e'),
              routes: [
                {
                  path: '/docs/',
                  component: d('/docs/', '22e'),
                  routes: [
                    {

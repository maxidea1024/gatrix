...
(globalThis.webpackChunkdocs = globalThis.webpackChunkdocs || []).push([
  [6366],
  {
    6307(e, s, n) {
      ...
      const r = JSON.parse(
        '{"id":"admin/users","title":"User Management","description":"Overview","source":"@site/docs/admin/users.md","sourceDirName":"admin","slug":"/admin/users","permalink":"/docs/admin/users","draft":false,"unlisted":false,"editUrl":"https://github.com/your-org/gatrix/tree/main/docs/docs/admin/users.md","tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"sidebar_position":5,"sidebar_label":"Users"},"sidebar":"tutorialSidebar","previous":{"title":"Client Versions","permalink":"/docs/admin/client-versions"},"next":{"title":"Overview","permalink":"/docs/integrations/overview"}}'
      );
      var i = n(4848),
        t = n(8453);

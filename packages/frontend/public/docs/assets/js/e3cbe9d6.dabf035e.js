...
(globalThis.webpackChunkdocs = globalThis.webpackChunkdocs || []).push([
  [2184],
  {
    ...
    8958(e, n, r) {
      ...
      const i = JSON.parse(
        '{"id":"admin/game-worlds","title":"Game Worlds","description":"Overview","source":"@site/docs/admin/game-worlds.md","sourceDirName":"admin","slug":"/admin/game-worlds","permalink":"/docs/admin/game-worlds","draft":false,"unlisted":false,"editUrl":"https://github.com/your-org/gatrix/tree/main/docs/docs/admin/game-worlds.md","tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"sidebar_position":3,"sidebar_label":"Game Worlds"},"sidebar":"tutorialSidebar","previous":{"title":"Whitelist","permalink":"/docs/admin/whitelist"},"next":{"title":"Client Versions","permalink":"/docs/admin/client-versions"}}'
      );
      var s = r(4848),
        t = r(8453);

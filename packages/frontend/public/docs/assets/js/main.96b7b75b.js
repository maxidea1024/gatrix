/*! For license information please see main.96b7b75b.js.LICENSE.txt */
  ...
  [8792],
  {
    ...
    8328(e, t, n) {
      ...
      const f = [
        ...
        {
          path: '/docs/',
          component: d('/docs/', '6a4'),
          routes: [
            {
              path: '/docs/',
              component: d('/docs/', '16b'),
              routes: [
                {
                  path: '/docs/',
                  component: d('/docs/', '958'),
                  routes: [
                    {

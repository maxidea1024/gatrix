/**
 * SDK configuration type definitions (CocosCreator)
 *
 * Differences from JS SDK:
 * - StorageProvider import from local path (no external dependency)
 * - Streaming config supports WebSocket only (SSE not available in CocosCreator)
 */

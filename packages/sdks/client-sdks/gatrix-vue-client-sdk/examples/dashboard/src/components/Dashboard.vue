...
import { useFlags, useGatrixClient, useFlagsStatus, useFetchFlags, useSyncFlags } from '@gatrix/gatrix-vue-client-sdk';
import type { GatrixClientConfig, EvaluatedFlag } from '@gatrix/gatrix-js-client-sdk';
    ...
    <section class="flags-section">
      <div class="nes-container is-dark with-title">
        ...
        <div v-if="isSearching" class="searching-state">
          <div class="searching-icon"><span>?îç</span></div>

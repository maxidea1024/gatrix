...
namespace Gatrix.Unity.SDK
{
    ...
    public interface IFeaturesClient
    {
        ...
        /// <returns>The <see cref="EvaluatedFlag"/>, or <c>null</c> if not found.</returns>
        EvaluatedFlag GetFlagRaw(string flagName, bool forceRealtime = true);
        ...
        string Variation(string flagName, string fallbackValue, bool forceRealtime = true);
        ...
        bool BoolVariation(string flagName, bool fallbackValue, bool forceRealtime = true);
        ...
        string StringVariation(string flagName, string fallbackValue, bool forceRealtime = true);
        ...
        int IntVariation(string flagName, int fallbackValue, bool forceRealtime = true);
        ...
        float FloatVariation(string flagName, float fallbackValue, bool forceRealtime = true);
        ...
        double DoubleVariation(string flagName, double fallbackValue, bool forceRealtime = true);
        ...
        Dictionary<string, object> JsonVariation(string flagName, Dictionary<string, object> fallbackValue, bool forceRealtime = true);
        ...
        Dictionary<string, object> JsonVariationOrThrow(string flagName, bool forceRealtime = true);
        ...
        VariationResult<bool> BoolVariationDetails(string flagName, bool fallbackValue, bool forceRealtime = true);
        ...
        /// <param name="fallbackValue">Default value if flag not found.</param>
        /// <returns>A <see cref="VariationResult{T}"/> with value and metadata.</returns>
        VariationResult<string> StringVariationDetails(string flagName, string fallbackValue, bool forceRealtime = true);
        ...
        /// <returns>A <see cref="UniTask"/> that completes when sync is done.</returns>
        UniTask SyncFlagsAsync(bool fetchNow = true);
        ...
        /// </para>
        /// </summary>
        /// <returns>A <see cref="UniTask"/> that completes when the fetch finishes.</returns>
        UniTask FetchFlagsAsync();

        // ==================== Watch ====================

        /// <summary>
        /// Watch a flag for realtime changes. Reacts immediately when flags are
        /// fetched from the server, regardless of explicitSyncMode.
        /// </summary>
        ...
        Action WatchRealtimeFlag(string flagName, GatrixFlagWatchHandler callback, string name = null);

        /// <summary>
        /// Watch a flag for realtime changes, receiving the current value immediately.
        /// Initial state always uses realtimeFlags (latest server state).
        /// </summary>
        Action WatchRealtimeFlagWithInitialState(string flagName, GatrixFlagWatchHandler callback, string name = null);

        /// <summary>
        /// Watch a flag for synced changes. In explicitSyncMode, reacts only when
        /// <see cref="SyncFlagsAsync"/> is called. In normal mode, behaves identically
        /// to realtime watch.
        /// </summary>
        Action WatchSyncedFlag(string flagName, GatrixFlagWatchHandler callback, string name = null);

        /// <summary>
        /// Watch a flag for synced changes, receiving the current value immediately.
        /// Initial state uses synchronizedFlags in explicitSyncMode, realtimeFlags otherwise.
        /// </summary>
        Action WatchSyncedFlagWithInitialState(string flagName, GatrixFlagWatchHandler callback, string name = null);

        /// <summary>
        /// Create a named watch group for batch management of flag watchers.
        /// </summary>
        /// <param name="name">A descriptive name for the watch group.</param>

...
describe('FlagProxy', () => {
  ...
  describe('undefined flag', () => {
    let proxy: FlagProxy;
    beforeAll(() => {
      proxy = (client as any).createProxyForWatch('non-existent-flag');
    });
  ...
  describe('enabled flag', () => {
    let proxy: FlagProxy;
    beforeAll(() => {
      proxy = (client as any).createProxyForWatch('enabled-flag');
    });
  ...
  describe('disabled flag', () => {
    let proxy: FlagProxy;
    beforeAll(() => {
      proxy = (client as any).createProxyForWatch('disabled-flag');
    });
  ...
  describe('string flag', () => {
    let proxy: FlagProxy;
    beforeAll(() => {
      proxy = (client as any).createProxyForWatch('string-flag');
    });
  ...
  describe('number flag', () => {
    let proxy: FlagProxy;
    beforeAll(() => {
      proxy = (client as any).createProxyForWatch('number-flag');
    });
  ...
  describe('json flag', () => {
    let proxy: FlagProxy;
    beforeAll(() => {
      proxy = (client as any).createProxyForWatch('json-flag');
    });
  ...
  describe('invalid number flag', () => {
    it('should return default value for invalid number', () => {
      const proxy = (client as any).createProxyForWatch('invalid-number-flag');
  ...
  describe('invalid json flag', () => {
    it('should return default value for invalid json', () => {
      const proxy = (client as any).createProxyForWatch('invalid-json-flag');
  ...
  describe('variationDetails', () => {
    describe('boolVariationDetails', () => {
      it('should return flag_not_found for non-existent flag', () => {
        const proxy = (client as any).createProxyForWatch('non-existent');
      ...
      it('should return correct details for enabled flag', () => {
        const proxy = (client as any).createProxyForWatch('enabled-flag');
        const result = proxy.boolVariationDetails(false);
      ...
      it('should return correct details for disabled flag', () => {
        const proxy = (client as any).createProxyForWatch('disabled-flag');
        const result = proxy.boolVariationDetails(false);
        expect(result.value).toBe(false);
    ...
    describe('stringVariationDetails', () => {
      it('should return correct details for string flag', () => {
        const proxy = (client as any).createProxyForWatch('string-flag');
    ...
    describe('numberVariationDetails', () => {
      it('should return correct value for valid number', () => {
        const proxy = (client as any).createProxyForWatch('number-flag');
    ...
    describe('jsonVariationDetails', () => {
      it('should return correct value for valid json', () => {
        const proxy = (client as any).createProxyForWatch('json-flag');

...
function StatsPanel({
  ...
  const renderMascotWithBubble = () => {
    ...
    return (
      <div
        className="mascot-outer-container"
        ...
        <div className="stats-grid-layout">
          ...
          >
            ...
            <div className="stats-modes-compact">
              <div
                className={`mode-item ${client.features.isOfflineMode() ? 'is-warning' : 'is-success'}`}
              >
                <span className="mode-label">NETWORK</span>
                <span className="mode-value">
                  {client.features.isOfflineMode() ? 'OFFLINE' : 'ONLINE'}
                </span>
              </div>
              <div
                className={`mode-item ${config.features?.refreshInterval === 0 && !client.features.isOfflineMode() ? 'is-warning' : 'is-info'}`}
              >
              ...
              <div
                className={`mode-item ${config.features?.explicitSyncMode && !client.features.isOfflineMode() ? 'is-warning' : 'is-info'}`}
              >

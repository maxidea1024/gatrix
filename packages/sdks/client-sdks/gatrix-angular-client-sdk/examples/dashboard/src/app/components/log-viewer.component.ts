...
@Component({
  ...
  styles: [`
    ...
    .log-info .log-event { color: #209cee; }
    .log-success .log-event { color: #92cc41; }
    .log-warning .log-event { color: #f7d51d; }
    .log-error .log-event { color: #e76e55; }
    .log-error .log-detail { color: #e76e55; }
  `],
})

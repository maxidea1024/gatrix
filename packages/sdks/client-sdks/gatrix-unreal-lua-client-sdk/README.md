...
Copy the `gatrix-unreal-lua-client-sdk` folder into your project's `Plugins/` directory alongside the `gatrix-unreal-client-sdk` plugin.
...
If your project uses a different Lua module name (not `Lua`), update `GatrixLuaClientSDK.Build.cs`:

...
private:
  ...
  static void PushVariantTable(lua_State* L, const struct FGatrixVariant& Variant,
                               EGatrixValueType ValueType = EGatrixValueType::String);

  // Push FGatrixEvaluatedFlag as a Lua table
  static void PushEvaluatedFlagTable(lua_State* L, const struct FGatrixEvaluatedFlag& Flag);

  // Push FGatrixContext as a Lua table
  static void PushContextTable(lua_State* L, const struct FGatrixContext& Context);

...
namespace Gatrix.Unity.SDK
{
    ...
    public class WatchFlagGroup
    {
        ...
        /// <summary>Watch a flag and add to this group (returns this for chaining)</summary>
        public WatchFlagGroup WatchFlag(string flagName, GatrixFlagWatchHandler callback)
        {
            var unsubscribe = _client.WatchFlag(flagName, callback);
            _unsubscribers.Add(unsubscribe);
            return this;
        }

        /// <summary>Watch a flag with initial state and add to this group</summary>
        public WatchFlagGroup WatchFlagWithInitialState(string flagName, GatrixFlagWatchHandler callback)
        {
            var unsubscribe = _client.WatchFlagWithInitialState(flagName, callback);
            _unsubscribers.Add(unsubscribe);
            return this;
        }

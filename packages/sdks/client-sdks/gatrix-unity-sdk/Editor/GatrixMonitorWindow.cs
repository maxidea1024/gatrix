...
namespace Gatrix.Unity.SDK.Editor
{
    ...
    public class GatrixMonitorWindow : EditorWindow
    {
        ...
        private Action<string, object[]> _eventListener;
        private bool _isListening;

        // Cached data
        private SdkStats _cachedStats;
        ...
        [MenuItem("Window/Gatrix/Monitor")]
        ...
        private void DrawOverview()
        {
            ...
            if (stats != null)
            {
                ...
                DrawField("Offline Mode", stats.OfflineMode ? "Yes" : "No");
        ...
        private void DrawFlagRow(EvaluatedFlag flag, int index)
        {
            ...
            // Type
            EditorGUILayout.LabelField(
                VariantTypeHelper.ToApiString(flag.VariantType), GUILayout.Width(55));
        ...
        private void DrawStatistics()
        {
            ...
            if (client != null)
            {
                ...
                var listenerCounts = emitter.GetAllListenerCounts();
                var totalCount = emitter.TotalListenerCount;
        ...
        private void RefreshData()
        {
            ...
            _cachedStats = client.GetStats();
            _cachedFlags = client.GetAllFlags();
            _cachedContext = client.GetContext();
        }

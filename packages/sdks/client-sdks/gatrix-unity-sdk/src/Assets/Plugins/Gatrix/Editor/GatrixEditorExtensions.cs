...
namespace Gatrix.Unity.SDK.Editor
{
    public static class GatrixEditorExtensions
    {
        ...
        public static void DrawFlagStatus(string flagName)
        {
            ...
            var isEnabled = client.Features.IsEnabled(flagName);
            var variant = client.Features.GetVariant(flagName);
            ...
            var stateText = isEnabled ? "\u25cf  ON" : "\u25cf  OFF";

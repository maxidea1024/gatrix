...
const name = 'Initial database schema for Gatrix';
...
async function up(connection) {
  ...
  // 7. Account whitelist table (formerly nickname whitelist)
  await connection.execute(`
  ...
  await connection.execute(`
    ...
    VALUES (1, 'Admin', 'admin@gatrix.local', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'active', TRUE, NOW(), NOW())
  `);

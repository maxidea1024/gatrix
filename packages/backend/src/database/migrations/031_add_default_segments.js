...
exports.up = async function (connection) {
  ...
  const defaultSegments = [
    // ==================== User Role Segments ====================
    {
      ...
      constraints: [{ contextName: 'role', operator: 'str_eq', value: 'admin' }],
    },
    {
    ...
    },
    {
      ...
      constraints: [{ contextName: 'purchaseCount', operator: 'num_eq', value: '0' }],
    },
    ...
    // ==================== Platform Segments ====================
    {
      ...
      constraints: [{ contextName: 'platform', operator: 'str_eq', value: 'pc' }],
    },
    {
      segmentName: 'mobile-users',
      displayName: 'Mobile Users',
      description: 'Users on mobile platform',
      constraints: [{ contextName: 'platform', operator: 'str_eq', value: 'mobile' }],
    },
    {
      segmentName: 'console-users',
      displayName: 'Console Users',
      description: 'Users on console platform',
      constraints: [{ contextName: 'platform', operator: 'str_eq', value: 'console' }],
    },
    ...
    // ==================== Region Segments ====================
    {
      ...
      constraints: [{ contextName: 'countryCode', operator: 'str_eq', value: 'KR' }],
    },
    {
      segmentName: 'china-users',
      displayName: 'China Users',
      description: 'Users in Chinese region',
      constraints: [{ contextName: 'countryCode', operator: 'str_in', values: ['CN', 'TW'] }],
    },
    {
      segmentName: 'japan-users',
      displayName: 'Japan Users',
      description: 'Users in Japanese region',
      constraints: [{ contextName: 'countryCode', operator: 'str_eq', value: 'JP' }],
    },
    {
      ...
      constraints: [
        {
          contextName: 'serverRegion',
          operator: 'str_in',
          values: ['kr', 'jp', 'cn', 'tw', 'sea'],
        },
      ],
    },
    {
    ...
    // ==================== Environment Segments ====================
    {
      ...
      constraints: [{ contextName: 'environment', operator: 'str_eq', value: 'development' }],
    },
    {
      segmentName: 'staging-env',
      displayName: 'Staging Environment',
      description: 'Staging environment only',
      constraints: [{ contextName: 'environment', operator: 'str_eq', value: 'staging' }],
    },
    {
      segmentName: 'production-env',
      displayName: 'Production Environment',
      description: 'Production environment only',
      constraints: [{ contextName: 'environment', operator: 'str_eq', value: 'production' }],
    },
    ...
    // ==================== A/B Test Groups ====================
    {
      ...
      constraints: [{ contextName: 'abGroup', operator: 'str_eq', value: 'control' }],
    },
    {
    ...
    // ==================== Device Segments ====================
    {
      ...
      constraints: [{ contextName: 'deviceType', operator: 'str_eq', value: 'windows' }],
    },
    {
      segmentName: 'ios-users',
      displayName: 'iOS Users',
      description: 'Users on iOS devices',
      constraints: [{ contextName: 'deviceType', operator: 'str_eq', value: 'ios' }],
    },
    {
      segmentName: 'android-users',
      displayName: 'Android Users',
      description: 'Users on Android devices',
      constraints: [{ contextName: 'deviceType', operator: 'str_eq', value: 'android' }],
    },
  ];
...
exports.down = async function (connection) {
  ...
  await connection.execute(
    'DELETE FROM g_feature_segments WHERE segmentName IN (' +

...
exports.down = async function (connection) {
  console.log(
    '⚠ This migration cannot be rolled back - remote config tables have been permanently removed'
  );
  console.log(
    'To restore remote config functionality, a new migration with the updated schema must be created'
  );
};

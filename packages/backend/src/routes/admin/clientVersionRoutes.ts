...
router.get(
  "/",
  requireAdmin as any,
  ClientVersionController.getClientVersions as any,
);
...
router.get(
  "/:id",
  requireAdmin as any,
  ClientVersionController.getClientVersionById as any,
);
...
router.get(
  "/:id/tags",
  requireAdmin as any,
  ClientVersionController.getTags as any,
);
router.put(
  "/:id/tags",
  requireAdmin as any,
  ClientVersionController.setTags as any,
);

...
router.post(
  "/users/:id/promote",
  auditUserPromote as any,
  AdminController.promoteToAdmin as any,
);
router.post(
  "/users/:id/demote",
  auditUserDemote as any,
  AdminController.demoteFromAdmin as any,
);
router.post("/users/:id/verify-email", AdminController.verifyUserEmail as any);

// User environment access
router.get(
  "/users/:id/environments",
  AdminController.getUserEnvironmentAccess as any,
);
router.put(
  "/users/:id/environments",
  AdminController.setUserEnvironmentAccess as any,
);

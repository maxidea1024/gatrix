...
import { IServiceDiscoveryProvider } from '../../types/service-discovery';
import { RedisServiceDiscoveryProvider } from './redis-service-discovery-provider';
import { EtcdServiceDiscoveryProvider } from './etcd-service-discovery-provider';

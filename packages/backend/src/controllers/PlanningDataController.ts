...
export class PlanningDataController {
  ...
  static getMateRecruitingGroupLookup = asyncHandler(
    async (req: AuthenticatedRequest, res: Response) => {
      ...
      res.json({
        success: true,
        data,
        message: "MateRecruitingGroup lookup data retrieved successfully",
      });
    },
  );
  ...
  static getOceanNpcAreaSpawnerLookup = asyncHandler(
    async (req: AuthenticatedRequest, res: Response) => {
      ...
      res.json({
        success: true,
        data,
        message: "OceanNpcAreaSpawner lookup data retrieved successfully",
      });
    },
  );
  ...
  static uploadPlanningData = asyncHandler(
    async (req: AuthenticatedRequest, res: Response) => {
      ...
      const { SSENotificationService } =
        await import("../services/sseNotificationService");
  ...
  static getLatestUpload = asyncHandler(
    async (req: AuthenticatedRequest, res: Response) => {
      ...
      const latestUpload =
        await PlanningDataService.getLatestUpload(environment);
  ...
  static resetUploadHistory = asyncHandler(
    async (req: AuthenticatedRequest, res: Response) => {
      ...
      const deletedCount =
        await PlanningDataService.resetUploadHistory(environment);

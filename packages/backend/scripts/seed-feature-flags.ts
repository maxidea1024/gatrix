...
async function main() {
    ...
    try {
        ...
        await createFlag({
            ...
            strategies: [
                { name: 'default', parameters: {}, isEnabled: true }
            ],
        });
        ...
        await createFlag({
            ...
            variants: [
                { variantName: 'control', weight: 50, payload: { version: 'A' }, payloadType: 'json' },
                { variantName: 'experiment', weight: 50, payload: { version: 'B' }, payloadType: 'json' },
            ],
        });
        ...
        await createFlag({
            ...
            strategies: [
                ...
                {
                    name: 'flexibleRollout',
                    parameters: { rollout: 20, stickiness: 'default', groupId: 'test-multi' },
                    isEnabled: true,
                    sortOrder: 1,
                },
            ],

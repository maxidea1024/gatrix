...
const columns = new Map<string, ColumnDef>([
  ...
  ['type',             { name: 'type',             type: 'String', lowCardinality: true, searchable: true }],
  ...
  ['server_name',      { name: 'server_name',      type: 'String', lowCardinality: true }],
  ...
  ['browser_name',     { name: 'browser_name',     type: 'String', lowCardinality: true }],
  ['browser_version',  { name: 'browser_version',  type: 'String', lowCardinality: true }],
  ['device_name',      { name: 'device_name',      type: 'String', lowCardinality: true }],
  ['device_family',    { name: 'device_family',    type: 'String', lowCardinality: true }],
  ['runtime_name',     { name: 'runtime_name',     type: 'String', lowCardinality: true }],
  ['runtime_version',  { name: 'runtime_version',  type: 'String', lowCardinality: true }],
  ['sdk_name',         { name: 'sdk_name',         type: 'String', lowCardinality: true }],
  ['sdk_version',      { name: 'sdk_version',      type: 'String', lowCardinality: true }],

  ['geo_country',      { name: 'geo_country',      type: 'FixedString', lowCardinality: true }],
...
export const errorsDataset: DatasetConfig = {
  ...
  aggregates: new Set([
    ...
    'countIf', 'sumIf', 'avgIf',
    'quantile', 'quantiles',
    'p50', 'p75', 'p95', 'p99',  // shorthand aliases
    'groupArray', 'topK',
  ]),
  columnAliases: {
    severity: 'level',
  ...
  materializedViews: [
    {
      ...
      availableAggregates: ['countMerge(event_count)', 'uniqMerge(affected_users)'],
      mergeFunctions: {

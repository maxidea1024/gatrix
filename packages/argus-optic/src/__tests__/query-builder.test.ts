...
describe('QueryBuilder', () => {
  ...
  describe('SELECT clause', () => {
    ...
    it('should generate select with aliases', () => {
      ...
      const { sql } = buildQuery(query);
      expect(sql).toMatch(
        /SELECT count\(\) AS total, uniq\(user_id\) AS users/
      );
    });
    ...
    it('should resolve log dataset aliases (severity ??level, logger ??logger_name)', () => {
      const query: OpticQuery = {
        ...
        projectId: 'proj-123',
        timeRange: { period: '24h' },
        select: [{ field: 'severity' }, { field: 'logger' }],
      };
  ...
  describe('aggregate functions', () => {
    ...
    it('should pass through countIf expressions', () => {
      const { sql } = buildQuery({
        ...
        timeRange: { period: '1h' },
        select: [
          { field: "countIf(transaction_status != 'ok')", alias: 'failures' },
        ],
      });
  ...
  describe('WHERE clause', () => {
    it('should always include project_id filter', () => {
      ...
      const pidParam = Object.entries(params).find(
        ([, v]) => v === 'my-project-id'
      );
    ...
    it('should add inequality condition', () => {
      const { sql } = buildQuery({
        ...
        timeRange: { period: '24h' },
        select: [{ field: 'count()' }],
        conditions: [{ field: 'level', op: '!=', value: 'debug' }],
      });
    ...
    it('should add numeric comparison condition', () => {
      const { sql } = buildQuery({
        ...
        timeRange: { period: '24h' },
        select: [{ field: 'count()' }],
        conditions: [{ field: 'duration', op: '>', value: 1000 }],
      });
    ...
    it('should add IN condition for array values', () => {
      const { sql, params } = buildQuery({
        ...
        timeRange: { period: '24h' },
        select: [{ field: 'count()' }],
        conditions: [{ field: 'level', op: 'IN', value: ['error', 'fatal'] }],
      });
    ...
    it('should add ILIKE condition', () => {
      const { sql } = buildQuery({
        ...
        timeRange: { period: '24h' },
        select: [{ field: 'count()' }],
        conditions: [{ field: 'value', op: 'ILIKE', value: '%timeout%' }],
      });
    ...
    it('should resolve condition column aliases', () => {
      const { sql } = buildQuery({
        ...
        timeRange: { period: '24h' },
        select: [{ field: 'count()' }],
        conditions: [{ field: 'severity', op: '=', value: 'error' }],
      });
  ...
  describe('GROUP BY clause', () => {
    it('should generate GROUP BY for plain columns', () => {
      const { sql } = buildQuery({
        ...
        projectId: 'p1',
        timeRange: { period: '24h' },
        select: [{ field: 'level' }, { field: 'count()', alias: 'count' }],
        groupBy: ['level'],
      });
  ...
  describe('HAVING clause', () => {
    it('should generate HAVING from explicit having conditions', () => {
      const { sql } = buildQuery({
        ...
        projectId: 'p1',
        timeRange: { period: '24h' },
        select: [{ field: 'level' }, { field: 'count()', alias: 'cnt' }],
        groupBy: ['level'],
        having: [{ field: 'cnt', op: '>', value: 10 }],
      });
  ...
  // ?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═??  // Search Integration (QueryParser)
  // ?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═??
  ...
  // ?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═??  // Full Query Assembly (Integration-like)
  // ?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═??
...
// ?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═??// Tag Distribution Query Builder
// ?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═?�═??
describe('buildTagDistributionQuery', () => {
  ...
  it('should include additional conditions', () => {
    const { sql } = buildTagDistributionQuery({
      ...
      timeRange: { period: '24h' },
      tags: ['level'],
      conditions: [{ field: 'issue_id', op: '=', value: 42 }],
    });

  ...
  app.post(
    ...
    async (
      ...
      try {
        ...
        return reply.send({ success: true, message: 'Reserved events and properties seeded' });
      } catch (error) {
        logger.error('Failed to seed lexicon', {
          projectId,
          error: error instanceof Error ? error.message : String(error),
        });
        return reply.code(500).send({ success: false, message: 'Failed to seed lexicon' });
      }
    }
  );
  ...
  app.get(
    ...
    async (
      ...
      try {
        ...
        return reply.code(500).send({ success: false, message: 'Failed to list lexicon events' });
      }
    }
  );
  ...
  app.post(
    ...
    async (
      ...
      if (!body.event_name || !body.event_name.trim()) {
        return reply.code(400).send({ success: false, message: 'event_name is required' });
      }
      ...
      try {
        ...
        logger.info('Lexicon event created', { projectId, eventName: body.event_name });
        return reply.code(201).send({ success: true });
      } catch (error: any) {
        if (error.code === 'ER_DUP_ENTRY') {
          return reply.code(409).send({ success: false, message: 'Event already exists in lexicon' });
        }
        logger.error('Failed to create lexicon event', {
          projectId,
          error: error instanceof Error ? error.message : String(error),
        });
        return reply.code(500).send({ success: false, message: 'Failed to create lexicon event' });
      }
    }
  );
  ...
  app.patch(
    ...
    async (
      ...
      try {
        ...
        if (!existing) {
          return reply.code(404).send({ success: false, message: 'Event not found in lexicon' });
        }
        ...
        return reply.code(500).send({ success: false, message: 'Failed to update lexicon event' });
      }
    }
  );
    ...
    async (
      ...
      try {
        ...
        if (existing.is_reserved) {
          return reply.code(403).send({ success: false, message: 'Cannot delete reserved system events' });
        }
        ...
        return reply.code(500).send({ success: false, message: 'Failed to delete lexicon event' });
      }
    }
  );
  ...
  app.get(
    ...
    async (
      ...
      try {
        ...
        return reply.code(500).send({ success: false, message: 'Failed to list lexicon properties' });
      }
    }
  );
  ...
  app.post(
    ...
    async (
      ...
      if (!body.property_name || !body.property_name.trim()) {
        return reply.code(400).send({ success: false, message: 'property_name is required' });
      }
      ...
      try {
        ...
        logger.info('Lexicon property created', { projectId, propertyName: body.property_name });
        return reply.code(201).send({ success: true });
      } catch (error: any) {
        if (error.code === 'ER_DUP_ENTRY') {
          return reply.code(409).send({ success: false, message: 'Property already exists in lexicon' });
        }
        logger.error('Failed to create lexicon property', {
          projectId,
          error: error instanceof Error ? error.message : String(error),
        });
        return reply.code(500).send({ success: false, message: 'Failed to create lexicon property' });
      }
    }
  );
  ...
  app.patch(
    ...
    async (
      ...
      try {
        ...
        if (!existing) {
          return reply.code(404).send({ success: false, message: 'Property not found in lexicon' });
        }
        ...
        return reply.code(500).send({ success: false, message: 'Failed to update lexicon property' });
      }
    }
  );
  ...
  app.delete(
    ...
    async (
      ...
      try {
        ...
        if (existing.is_reserved) {
          return reply.code(403).send({ success: false, message: 'Cannot delete reserved system properties' });
        }
        ...
        return reply.code(500).send({ success: false, message: 'Failed to delete lexicon property' });
      }
    }
  );
}

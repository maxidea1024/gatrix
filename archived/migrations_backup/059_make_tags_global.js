...
module.exports = {
  ...
  async up(db) {
    ...
    try {
      ...
      console.log(
        'Foreign key fk_g_tags_environment may not exist or different name, trying to continue...'
      );
  ...
  async down(db) {
    ...
    if (!defaultEnvId) {
      console.log(
        'Development environment not found, cannot revert properly without an environment ID.'
      );

...
const TABLES_TO_RENAME = ['g_remote_config_templates', 'g_remote_config_metrics'];

const TABLES_TO_REMOVE_ID = ['g_remote_config_segments', 'g_remote_config_campaigns'];
...
module.exports = {
  ...
  async down(db) {
    console.log(
      'Rollback for 070 is not fully implemented due to complexity of mapping back to ULIDs.'
    );
  },
};

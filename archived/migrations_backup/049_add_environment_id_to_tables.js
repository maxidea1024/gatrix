/**
 * Migration: Add environmentId to existing tables for multi-environment support
 *
 * This migration adds environmentId column (CHAR(26) ULID) to all tables that need environment separation.
...
module.exports = {
  id: '049_add_environment_id_to_tables',

...
# Available services (Swarm edition: no chat-server, no event-lens)
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -s|--service)
            ...
            ;;
        -h|--help)
            echo "Gatrix Build and Push Script (Swarm Edition)"
            echo ""
            ...
            echo ""
            echo "Available services: backend, frontend, edge"
            echo ""
            echo "Example:"
...
echo "========================================"
echo "   Gatrix Build & Push (Swarm Edition)"
echo "========================================"
